...
//   void _addtable_row() {
//     clientreq_table_heading = TableHeadingController.text;
//     // if (_notetable_formKey.currentState?.validate() ?? false) {
//     // Check if note Name already exists
//     bool exists = clientreq_recommendationList.any((note) => note['key'] == tablekey_Controller.text);
//     if (exists) {
...
//     setState(
//       () {
//         clientreq_recommendationList.add({
...
//         });
//         notetablelength = clientreq_recommendationList.length;
//         _cleartable_Fields();
//       },
//     );
//     // }
...
//       setState(
//         () {
//           clientreq_noteList[noteeditIndex!] = {
//             // 'notetype': selectedheadingType ?? '',
//             // 'noteheading': selectedheadingType == 'With Heading' ? NoteHeadingController.text : '',
...
//           _clearnoteFields();
//           noteeditIndex = null;
//           notelength = clientreq_noteList.length;
//         },
//       );
//     }
//   }
...
//   void _updatetable() {
//     // if (_notetable_formKey.currentState?.validate() ?? false) {
//     clientreq_recommendationList[notetable_editIndex!] = {
//       // 'notetype': selectedheadingType ?? '',
//       // 'noteheading': selectedheadingType == 'With Heading' ? NoteHeadingController.text : '',
...
//     Map<String, dynamic> note = clientreq_noteList[index];
//     setState(
//       () {
...
//     Map<String, dynamic> note = clientreq_recommendationList[index];
//     setState(
//       () {
//         // NoteHeadingController.text = note['noteheading'] ?? '';
...
//     if (_noteformKey.currentState?.validate() ?? false) {
//       // Check if note Name already exists
//       bool exists = clientreq_noteList.any((note) => note['notename'] == notecontentController.text);
//       if (exists) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
//             backgroundColor: Colors.blue,
...
//         itemCount: clientreq_noteList.length,
...
//                             children: [
//                               Text(
//                                 '${clientreq_noteList[index]['notecontent']}', // Display camera type from map
...
//                       onPressed: () {
//                         setState(() {
//                           clientreq_noteList.removeAt(index);
//                           notelength = clientreq_noteList.length;
//                         });
//                       },
//                       icon: const Icon(
...
//   Widget noteTable() {
//     return ListView.builder(
//         itemCount: clientreq_recommendationList.length,
//         itemBuilder: (context, index) {
//           return GestureDetector(
//             onTap: () {
...
//                             children: [
//                               Text(
//                                 '${clientreq_recommendationList[index]['key']}', // Display camera type from map
//                                 style: const TextStyle(color: Primary_colors.Color1, fontSize: 10),
//                               ),
//                             ],
//                           )),
...
//                       onPressed: () {
//                         setState(() {
//                           clientreq_recommendationList.removeAt(index);
//                           notetablelength = clientreq_recommendationList.length;
//                         });
//                       },
//                       icon: const Icon(
...
//     clientreq_recommendationList.isEmpty ? TableHeadingController.clear() : null;
...
//             ),
//             // const SizedBox(height: 10),
//             if (clientreq_noteList.isNotEmpty)
//               Expanded(
//                 child: Column(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   children: [
...
//               ),
//             const SizedBox(height: 10),
//             if (clientreq_recommendationList.isNotEmpty)
//               Expanded(
//                 child: Column(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   children: [
...
//                     },
//                   ),
//                   if (clientreq_noteList.isNotEmpty) const SizedBox(width: 10),
//                   if (clientreq_noteList.isNotEmpty || clientreq_recommendationList.isNotEmpty)
//                     Button1(
//                       colors: Colors.green,
//                       text: 'Submit',
//                       onPressed: () async {
...
//                             clientreq_client_addr_name.isNotEmpty &&
//                             clientreq_client_addr.isNotEmpty &&
//                             clientreq_bill_addr_name.isNotEmpty &&
//                             clientreq_bill_addr.isNotEmpty) {
//                           final pdfData = await generate_clientreq(PdfPageFormat.a4, clientreq_products, clientreq_client_addr_name, clientreq_client_addr, clientreq_bill_addr_name,
//                               clientreq_bill_addr, clientreq_no, clientreqDetailsState.pickedFile!.files.single.path);
